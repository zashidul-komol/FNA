									...
									<script>
									 ...
									 <!-- Details main body  -->
										<div id='tabs{$packageID}' style='width:100%px; font-family:Arial, Helvetica, sans-serif; font-size:12px; border: 0;'>
											<ul>
												<li><a href='#tabs{$packageID}-1'>Procurement Plan</a></li>
												<li><a href='#tabs{$packageID}-2'>PQ Stage</a></li>
		...
		$packageView .= " <!-- Tab 4 Start -->
				...
				if($packageCount>0) {
					...
					while($packageStatementData	= mysql_fetch_array($packageStatement)) {
						...
						else{$bps_38a_date = $packageStatementData["bps_38a"];}
						...
						$packageView .= "
										...
										<tr style='background:#DDDDDD;'>
											...
											<td style='text-align:left;width:30%;padding-left:10px;'> Planned Date of Procurement Notice:</td><td style='width: 18%; text-align:left;padding-left:10px;'> $bps_38a_null $bps_38a_date</td><td style='width:1%; background:#ffffff;'></td>
		...
		$packageView .= " <!-- Tab 5 Start -->
				...
				if($packageCount>0) {
					...
					while($packageStatementData	= mysql_fetch_array($packageStatement)) {
						...
						else{$bpes_54a_date = $packageStatementData["bpes_54a"];}
						...
						$packageView .= "
										...
										<tr style='background:#DDDDDD;'>
											...
											<td style='text-align:left;width:30%;padding-left:10px;'> Planned Date of Bids Opening :</td><td style='width:18%;text-align:left;padding-left:10px;'> $bpes_54a_null $bpes_54a_date</td>
		...
		$packageView .= " <!-- Tab 6 Start -->
				...
				if($packageCount>0) {
					...
					while($packageStatementData	= mysql_fetch_array($packageStatement)) {
						...
						else{$eras_60a_date = $packageStatementData["eras_60a"];}
						...
						else{$eras_62a_date = $packageStatementData["eras_62a"];}
						...
						$packageView .= "
										...
										<tr style='background:#DDDDDD;'>
											<td style='text-align:left;width:30%;padding-left:10px;'> Planned Date of BER Sent to ADB:</td><td style='width: 18%;text-align:left;padding-left:10px;'> $eras_60a_null $eras_60a_date</td><td style='width:1%; background:#ffffff;'></td>
											<td style='text-align:left;width:30%;padding-left:10px;'> Planned Date of EA's Approval on BER (all):</td><td style='width: 18%;text-align:left;padding-left:10px;'> $eras_62a_null $eras_62a_date</td>
										</tr>
		...
		$packageView .= "<!-- Tab 7 Start -->
				...
				if($packageCount>0) {
					...
					while($packageStatementData	= mysql_fetch_array($packageStatement)) {
						...
						else{$cs_63a_date = $packageStatementData["cs_63a"];}
						...
						else{$cs_67a_date = $packageStatementData["cs_67a"];}
						...
						$packageView .= "
										...
										<tr style='background:#DDDDDD;'>
											<td style='text-align:left;width:30%;padding-left:10px;'> Planned Date of NOA Issued to Successful Bidder:</td><td style='width: 18%;text-align:left;padding-left:10px;'> $cs_63a_null $cs_63a_date</td><td style='width:1%; background:#ffffff;'></td>
											<td style='text-align:left;width:30%;padding-left:10px;'>Planned Date of Contract Signing : </td><td style='width: 18%;text-align:left;padding-left:10px;'>$cs_67a_null $cs_67a_date </td>
										</tr>
		...
		$packageView .= " <!-- Tab 8 Start -->
				...
				if($packageCount>0) {
					...
					while($packageStatementData	= mysql_fetch_array($packageStatement)) {
						...
						else{$cms_72a_date = $packageStatementData["cms_72a"];}
						...
						$packageView .= "
										...
										<tr class='$packageClass'>
											...
											<td style='text-align:left;width:30%;padding-left:10px;'> Planned date: </td><td style='width:18%;text-align:left;'> $cms_72a_null $cms_72a_date </td>
										</tr>
