	...
	$tableView .="<table width='70%' border='0' cellpadding='3' cellspacing='0' style='margin:0px auto 0px auto;font-size:85%; border: 1px dotted #000'>
					  ...
					  <tr>
						<td colspan='18' align='center' valign='middle' style='border: 1px dotted #000'>
							...
							<center>&nbsp;</center>
							<center><b><font size=4>Feed Mill Finished Goods Stock Report</FONT></b></center>
							<center>&nbsp;</center>
					  ...
					  <tr style='font-weight:bold;'>
						...
						<td align='center' valign='middle'  style='border: 1px dotted #000'>Total Production (KG)</td>
...
// Query here.
						...
						$FoodQuery	 		= "SELECT f.FOODID
												...
												AND 	f.SUBPROJECTID 	= '".$SUBPROJECTID."'
											"; 
						...
						foreach($FOOD_ARRAY_UNIQUE as $individualFood){
							...
							$BALANCE_QNTY				= $Total_ProdQnty - $Total_FoodDistQnty ; 
							$BALANCE_TAKA				= $Total_Food_Cost - $Total_Prod_Cost ; 
							
							$GLOBAL_BALANCE_TAKA 		= $GLOBAL_BALANCE_TAKA + $BALANCE_TAKA ;
							
							$Global_PROD_QNTY			= $Global_PROD_QNTY + $Total_ProdQnty ; 
							$Global_TOTAL_COST		 	= $Global_TOTAL_COST + $Total_Prod_Cost ; 
						...
						$tableView .=" <tr>
											...
											<td align='right' valign='top' style='border: 1px dotted #000'>".number_format($Total_ProdQnty,2)."&nbsp;&nbsp;&nbsp;KG</td>

											<td align='right' valign='top' style='border: 1px dotted #000'>".number_format($Total_Prod_Cost,2)."</td>
					...
					$tableView .="
						...
						<tr style='font-weight:bold;'>
							...
							<td align='right' valign='top' style='border: 1px dotted #000'>".number_format($Global_PROD_QNTY,2)."&nbsp;&nbsp;&nbsp;KG</td>

							<td align='right' valign='top'  style='border: 1px dotted #000'>".number_format($Global_TOTAL_COST,2)."</td>

							<td align='right' valign='top' style='border: 1px dotted #000'>".number_format($Global_USE_QNTY,2)."</td>

							<td align='right' valign='top' style='border: 1px dotted #000'>".number_format($Global_USE_COST,2)."</td>
