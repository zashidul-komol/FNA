...
function insertDateMySQlFormat($date){
	...
	$PROJECTID_FORM 		= $_REQUEST['PROJECTID'];
	$SUBPROJECTID_FORM		= $_REQUEST['SUBPROJECTID'];
		...
		//Ministry/Division and Project/Programme Name View Report Start				
	 	$labourSql 	= "
			...
			$SubProjSql 	= "
							...
							WHERE sp.SUBPROJECTID = '".$SUBPROJECTID_FORM."'
						";
	...
	$tableView .="<table width='90%' border='0' cellpadding='3' cellspacing='0' style='margin:0px auto 0px auto;font-size:85%; border: 1px dotted #000'>
					  ...
					  <tr>
						<td colspan='13' align='center' valign='middle' style='border: 1px dotted #000'>
							...
							<center>&nbsp;</center>
							<center><b><font size=4> $SUBPROJECTNAME  -- Labour Bill </FONT></b></center>
							<center>&nbsp;</center>
...
// Query here.
						...
						$ProdQuery	 		= "SELECT PRODUCTID
												FROM fna_product  
												WHERE PROJECTID = '".$PROJECTID_FORM."'
												AND SUBPROJECTID = '".$SUBPROJECTID_FORM."'
												AND PRODCATTYPEID = '".$PRODCATTYPEID_FORM."'
											"; 
							...
							$prodFareQueryStatement				= mysql_query($prodFare);
								...
								$labourPaymntAmount = "
														...
														FROM
																fna_labourbill b
														WHERE b.LABOURID = '".$LABOURID_FORM."'
														AND b.PROJECTID = '".$PROJECTID_FORM."'
														AND b.SUBPROJECTID = '".$SUBPROJECTID_FORM."'
