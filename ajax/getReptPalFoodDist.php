					...
					<tr>
					  ...
					  <tr>
						<td colspan='18' align='center' valign='middle' style='border: 1px dotted #000'>
							...
							<center>&nbsp;</center>
							<center><b><font size=4>Poultry Batch Wise Food Distribution Report</FONT></b></center>
							<center>&nbsp;</center>
					  ...
					  <tr style='font-weight:bold;'>
						...
						<td align='center' valign='middle' style='border: 1px dotted #000'>Food Quantity (Kg)</td>
						
						<td align='center' valign='middle' style='border: 1px dotted #000'>Mor/Mur Qnty</td>
						
						<td align='center' valign='middle' style='border: 1px dotted #000'>Standard Food (Gram) </td>
						
						<td align='center' valign='middle' style='border: 1px dotted #000'>Avg Food (Gram) </td>
						
						<td align='center' valign='middle' style='border: 1px dotted #000'>Avg Taka/Murgi </td>
						
						<td align='center' valign='middle' style='font-weight:bold;border: 1px dotted #000'>Total Price</td>
...
// Query here.
						...
						$BasicQuery 	= "SELECT fd.FOODID,
												  ...
												  sfq.QUANTITY
												FROM pal_fooddistribute fd, feed_fooditem fi, feed_standardfood sfq
												WHERE fi.FOODID = fd.FOODID
												AND fi.FOODID = sfq.FOODID
												{$con}
												AND FDDATE BETWEEN '".$OPENINGDATE_FROM."' AND '".$OPENINGDATE_TO."'
						...
						while($BasicQueryStatementData	= mysql_fetch_array($BasicQueryStatement)){	
							...
							$FOODWEIGHT		 			= $BasicQueryStatementData['FOODWEIGHT'];
							$TOTALPRICE		 			= $BasicQueryStatementData['TOTALPRICE'];
							$FDDATE			 			= $BasicQueryStatementData['FDDATE'];
							$MUR_MOR_QNTY	 			= $BasicQueryStatementData['MUR_MOR_QNTY'];
							$FOODNAME		 			= $BasicQueryStatementData['FOODNAME'];
							$STANDARD_QUANTITY 			= $BasicQueryStatementData['QUANTITY'];
							
							$Global_Quantity			= $Global_Quantity + $FOODWEIGHT ; 
							$Global_Price				= $Global_Price + $TOTALPRICE ; 
							$AVG_GRAM_PER_Mur			= ($FOODWEIGHT / $MUR_MOR_QNTY ) * 1000 ;
							$AVG_TAKA_PER_MUR			= $TOTALPRICE / $MUR_MOR_QNTY ;  
							
						$tableView .=" <tr>
											<td align='center' valign='top' style='border: 1px dotted #000'>$SL</td>

											<td align='center' valign='top' style='border: 1px dotted #000'>$FDDATE</td>
											...
											<td align='center' valign='top' style='border: 1px dotted #000'>".number_format($FOODWEIGHT,2)."</td>
											
											<td align='center' valign='top' style='border: 1px dotted #000'>$MUR_MOR_QNTY</td>
											
											<td align='center' valign='top' style='border: 1px dotted #000'>".number_format($STANDARD_QUANTITY)."</td>
											<td align='center' valign='top' style='border: 1px dotted #000'>".number_format($AVG_GRAM_PER_Mur,2)."</td>
											
											<td align='center' valign='top' style='border: 1px dotted #000'>".number_format($AVG_TAKA_PER_MUR,2)."</td>
											
											<td align='center' valign='top' style='border: 1px dotted #000'>".number_format($TOTALPRICE,2)."</td>
					...
					$tableView .="
						...
						<tr style='font-weight:bold;'>
							...
							<td align='center' valign='top' style='border: 1px dotted #000'>".number_format($Global_Quantity,2)."</td>
