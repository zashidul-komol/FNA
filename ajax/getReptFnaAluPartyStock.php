	...
	$tableView .="<table width='60%' border='0' cellpadding='3' cellspacing='0' style='margin:0px auto 0px auto;font-size:85%; border: 1px dotted #000'>
					  ...
					  <tr>
						<td colspan='18' align='center' valign='middle' style='border: 1px dotted #000'>
							...
							<center>&nbsp;</center>
							<center><b><font size=4>Party Wise Alu / Fruits Stock Report</FONT></b></center>
							<center>&nbsp;</center>
					  ...
					  <tr>
						...
						<td colspan='18' align='left' valign='top'>
							<table width='100%' border='0' cellpadding='3' cellspacing='0' style='margin:0px auto 0px auto;font-size:100%; font-weight:bold;'>
								  <tr>
								
									<td width='20%' align='left' valign='top'>Party Name<b></td>
									<td width='1%' align='center' valign='top'>:</td>
									<td width='30%' align='left' valign='top'> $PARTYNAME</td>
...
// Query here.
						...
						$basicQuery 	= "SELECT	
												...
												p.PRODUCTNAME			
										FROM fna_productloadunload lc, fna_alustock alustck, fna_productloadunloadbkdn bkdn, fna_product p
										...
										AND p.PRODUCTID = alustck.PRODUCTID
						...
						while($basicQueryStatementData	= mysql_fetch_array($basicQueryStatement)){
							...
							$LOADQUANTITY_ALU 	= $basicQueryStatementData['LOADQUANTITY'];
							$UNLOADQUANTITY_ALU = $basicQueryStatementData['UNLOADQUANTITY'];
							...
							$PRODUCTNAME_ALU	= $basicQueryStatementData['PRODUCTNAME'];
							
							
							
							$globalReceQnty 	= $globalReceQnty + $LOADQUANTITY_ALU ; 
							$globalDelevQnty 	= $globalDelevQnty + $UNLOADQUANTITY_ALU ; 
							$Balance_Qnty 		= $globalReceQnty - $globalDelevQnty ;
							
							$NowLotNo					=  $LotNo .'/'. $LOADQUANTITY_ALU ; 
							 // Dynamic Row Start
						...
						$tableView .=" <tr>
											...
											<td align='center' valign='top' style='border: 1px dotted #000'>$PRODUCTNAME_ALU</td>
					
											<td align='center' valign='top'  style='border: 1px dotted #000'>$ENTRYDATE_ALU</td>
											
											<td align='center' valign='top'  style='border: 1px dotted #000'>$LOADQUANTITY_ALU</td>
					
											<td align='center' valign='top' style='border: 1px dotted #000'>$UNLOADQUANTITY_ALU</td>
				...
				$sl++;
					...
					$tableView .="
						...
						<tr style='font-weight:bold;'>
							...
							<td colspan='4' align='right' valign='top' style='border: 1px dotted #000'>Grand Total : </td>

							<td align='center' valign='top' style='border: 1px dotted #000'>$globalReceQnty</td>

							<td align='center' valign='top' style='border: 1px dotted #000'>$globalDelevQnty</td>
