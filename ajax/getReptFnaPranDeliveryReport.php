...
function insertDateMySQlFormat($date){
	...
	$tableView .="<table width='70%' border='0' cellpadding='3' cellspacing='0' style='margin:0px auto 0px auto;font-size:85%; border: 1px dotted #000'>
					  ...
					  <tr>
						<td colspan='7' align='center' valign='middle' style='border: 1px dotted #000'>
							<center><b><font size=2>Product Delivery Information</FONT></b></center>
						</td>
					  </tr>
					  <tr>
						<td colspan='7' align='center' valign='middle' style='border: 1px dotted #000'>
					  ...
					  <tr>
						...
						<td align='left' valign='top' style='border: 1px dotted #000'>Delivery Challan Number</td>

						<td align='left' valign='top' style='border: 1px dotted #000'>Delivered Quantity </td>
...
// Query here.
							...
							// Package Information View Report Start 	 <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<		
								...
								while($aViewStatementData	= mysql_fetch_array($aViewStatement)){ 
								 ...
								 $DELIVERYCHALLANNUMBER     = $aViewStatementData["DELIVERYCHALLANNUMBER"];  
							...
							$GlobalTotQnty	= $GlobalTotQnty + $TOTALQUANTITY ; 
							//-----------------------------------------------------------------
 ...
 // Dynamic Row Start
						...
						$tableView .=" <tr>
											...
											<td align='left' valign='top' style='border: 1px dotted #000'> $DELIVERYCHALLANNUMBER</td>
											...
											<td align='right' valign='top' style='border: 1px dotted #000'>$TOTALQUANTITY </td>
					...
					$tableView .="
						...
						<tr>
							...
							<td align='right' valign='top' style='border: 1px dotted #000'>$GlobalTotQnty</td>
