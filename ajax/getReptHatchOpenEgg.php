					...
					<tr>
					  ...
					  <tr>
						<td colspan='18' align='center' valign='middle' style='border: 1px dotted #000'>
							...
							<center>&nbsp;</center>
							<center><b><font size=4>Hatching Egg Status Report</FONT></b></center>
							<center>&nbsp;</center>
					  ...
					  <tr style='font-weight:bold;'>
						...
						<td align='center' valign='middle' style='border: 1px dotted #000'>Average Price</td>
...
// Query here.
						...
						$Global_Quantity = 0;
						$Global_Price	= 0;
						$BasicQuery 	= "SELECT ohe.BATCHNO,
												  ohe.EGGQUANTITY,
												  ohe.PRICE,
												  ohe.OPENDATE,
												  ohe.AVGRATEPEREGG
												FROM hatch_opening_hatching_egg ohe
												WHERE ohe.OPENDATE BETWEEN '".$OPENINGDATE_FROM."' AND '".$OPENINGDATE_TO."'
												{$con}
												AND ohe.PROJECTID = '".$PROJECTID."'
						...
						while($BasicQueryStatementData	= mysql_fetch_array($BasicQueryStatement)){	
							...
							$EGGQUANTITY	 			= $BasicQueryStatementData['EGGQUANTITY'];
							$PRICE			 			= $BasicQueryStatementData['PRICE'];
							$OPENDATE		 			= $BasicQueryStatementData['OPENDATE'];
							$AVGRATEPEREGG	 			= $BasicQueryStatementData['AVGRATEPEREGG'];
							
							$Global_Quantity			= $Global_Quantity + $EGGQUANTITY ; 
							$Global_Price				= $Global_Price + $PRICE ;
							$AvgPrice					= $PRICE / $EGGQUANTITY ; 
							$Global_AVG_Price			= $Global_Price / $Global_Quantity ; 
					...
					$tableView .="
						...
						<tr style='font-weight:bold;'>
							...
							<td align='center' valign='top' style='border: 1px dotted #000'>".number_format($Global_AVG_Price,2)."</td>
