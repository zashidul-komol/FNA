					...
					<tr>
					  ...
					  <tr>
						<td colspan='18' align='center' valign='middle' style='border: 1px dotted #000'>
							...
							<center>&nbsp;</center>
							<center><b><font size=4>Poultry Opening Batch Report</FONT></b></center>
							<center>&nbsp;</center>
					  ...
					  <tr style='font-weight:bold;'>
						...
						<td align='center' valign='middle' style='border: 1px dotted #000'>Live Quantity</td>
...
// Query here.
						...
						$BasicQuery 	= "SELECT *
												FROM pal_batchopen
												WHERE BDATE BETWEEN '".$OPENINGDATE_FROM."' AND '".$OPENINGDATE_TO."'
						...
						while($BasicQueryStatementData	= mysql_fetch_array($BasicQueryStatement)){	
							...
							$BWISELIVESTOCK	 			= $BasicQueryStatementData['BWISELIVESTOCK'];
							$PRICE			 			= $BasicQueryStatementData['PRICE'];
							$BDATE			 			= $BasicQueryStatementData['BDATE'];
							
							$Global_Quantity			= $Global_Quantity + $BWISELIVESTOCK ; 
						...
						$tableView .=" <tr>
											...
											<td align='center' valign='top' style='border: 1px dotted #000'>".number_format($BWISELIVESTOCK,2)."</td>
