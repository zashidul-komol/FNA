...
function insertDateMySQlFormat($date){
	...
	$tableView .="<table width='80%' border='0' cellpadding='3' cellspacing='0' style='margin:0px auto 0px auto;font-size:85%; border: 1px dotted #000'>
					  ...
					  <tr style='font-weight:bold;'>
						...
						<td align='center' valign='top' style='border: 1px dotted #000'>Floor name </td>
...
// Query here.
							...
							// Package Information View Report Start 	 <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<		
								...
								$aViewQuery 	= 	"SELECT  	SUM(LOADQUANTITY) AS LOADQUANTITY,
																SUM(UNLOADQUANTITY) AS UNLOADQUANTITY,
																SUM(POCKETBALANCE) AS POCKETBALANCE,
																PARTYID,
																CHID,
																FLOORID,
																POCKETID,
						...
						$tableView .=" <tr>
											...
											<td align='center' valign='top' style='border: 1px dotted #000' width='20%'> $FLOORNAME</td>
