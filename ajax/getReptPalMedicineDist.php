					...
					<tr>
					  ...
					  <tr>
						<td colspan='18' align='center' valign='middle' style='border: 1px dotted #000'>
							...
							<center>&nbsp;</center>
							<center><b><font size=4>Poultry Batch Wise Medicine Distribution Report</FONT></b></center>
							<center>&nbsp;</center>
					  ...
					  <tr style='font-weight:bold;'>
						...
						<td align='center' valign='middle'  style='border: 1px dotted #000'>Medicine Name</td>

						<td align='center' valign='middle' style='border: 1px dotted #000'>Quantity (Kg)</td>
...
// Query here.
						...
						$BasicQuery 	= "SELECT m.BATCHNO,
												  ...
												  m.MDDATE,
												  p.PRODUCTNAME
												FROM pal_medicine m, fna_product p
												WHERE p.PRODUCTID = m.PRODUCTID
												{$con}
												AND m.MDDATE BETWEEN '".$OPENINGDATE_FROM."' AND '".$OPENINGDATE_TO."'
												ORDER BY m.MDDATE ASC
											"; 
						...
						while($BasicQueryStatementData	= mysql_fetch_array($BasicQueryStatement)){	
							...
							$MDDATE			 			= $BasicQueryStatementData['MDDATE'];
							$PRODUCTNAME	 			= $BasicQueryStatementData['PRODUCTNAME'];
							$WTID			 			= $BasicQueryStatementData['WTID'];
							
							$Wt_Qry						= mysql_fetch_array(mysql_query("Select WNAME from fna_weight WHERE WTID = '".$WTID."'"));
							$WNAME						= $Wt_Qry['WNAME'];
						...
						$tableView .=" <tr>
											...
											<td align='center' valign='top' style='border: 1px dotted #000'>$MDDATE</td>
