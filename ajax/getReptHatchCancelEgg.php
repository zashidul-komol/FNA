					...
					<tr>
					  ...
					  <tr>
						<td colspan='18' align='center' valign='middle' style='border: 1px dotted #000'>
							...
							<center>&nbsp;</center>
							<center><b><font size=4>Cancel Egg Status Report</FONT></b></center>
							<center>&nbsp;</center>
...
// Query here.
						...
						$Global_Quantity = 0;
						$Global_Price	= 0;
						$BasicQuery 	= "SELECT ohe.EGGQUANTITY,
												  ohe.OPENDATE,
												  ohe.AVGRATEPEREGG
						...
						while($BasicQueryStatementData	= mysql_fetch_array($BasicQueryStatement)){	
							...
							$price						= $AVGRATEPEREGG * $EGGQUANTITY ; 
							...
							$tableView .=" <tr>
											...
											<td align='center' valign='top'  style='border: 1px dotted #000'>".number_format($AVGRATEPEREGG,2)."</td>
