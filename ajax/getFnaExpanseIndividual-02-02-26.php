...
// Query here.
						...
						$basicQuery 		= "SELECT exp.EXPHID,
												...
												FROM fna_expanse exp, fna_expense_head ehn, fna_project proj, fna_subproject subproj
												WHERE ehn.EXPHID = exp.EXPHID
												AND proj.PROJECTID = exp.PROJECTID
												AND proj.PROJECTID = subproj.PROJECTID
						...
						$tableView .=" <tr>
											...
											<td width='5%' align='center' valign='top' style='border: 1px dotted #000'>$EXPDATE</td>
...
// Query here.
						...
						$tableView .=" <tr>
											...
											<td width='10%' align='center' valign='top' style='border: 1px dotted #000'>$EXPDATE</td>
