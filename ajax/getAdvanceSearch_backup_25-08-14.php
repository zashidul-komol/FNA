<?php
									 ...
									 <!-- Details main body  -->
										<div id='tabs{$packageID}' style='width:100%px; font-family:Arial, Helvetica, sans-serif; font-size:12px; border: 0;'>
											<ul>
												...
												<li><a href='#tabs{$packageID}-9'>Contract Closing Stage</a></li>
					...
					while($packageStatementData	= mysql_fetch_array($packageStatement)) {
						...
						$packageView .= "
										...
										<tr style='background:#DDDDDD;'>
											...
											<td style='text-align:left;width:35%;padding-left:10px;'> Revised Scheduled Completion Date: </td><td style='width:13%;text-align:left;padding-left:10px;'> $cms_73_null $cms_73_date </td>
										</tr>
										
										<tr class='$packageClass'>
											<td style='text-align:left;width:35%;padding-left:10px;'> Actual Completion Date:</td><td style='width: 13%;text-align:left;padding-left:10px;'> $cms_74_null $cms_74_date</td><td style='width:1%; background:#ffffff;'></td>
											<td style='text-align:left;width:35%;padding-left:10px;'> Final Acceptance Date:</td><td style='width: 13%;text-align:left;padding-left:10px;'> $cms_75_null $cms_75_date</td>
										</tr>
										
										<tr style='background:#DDDDDD;'>
											<td style='text-align:left;width:35%;padding-left:10px;'>Number of Contract Amendments:</td><td style='width: 13%;text-align:left;padding-left:10px;'> $cms_107</td><td style='width:1%; background:#ffffff;'></td>
											<td style='text-align:left;width:35%;padding-left:10px;'>Number of Variation Order:</td><td style='width: 13%;text-align:left;padding-left:10px;'>$cms_108</td>
										</tr>
										
										<tr class='$packageClass'>
											<td style='text-align:left;width:35%;padding-left:10px;'> Variation Order Amount (Equiv. US$):</td><td style='width: 13%; text-align:left;padding-left:10px;'>".number_format($cms_109,2)."</td><td style='width:1%; background:#ffffff;'></td>
											<td style='text-align:left;width:35%;padding-left:10px;'>  </td><td style='width:13%;text-align:left;padding-left:10px;'>  </td>
	...
	$packageQuery = "
								SELECT
										adbs_paymentstage.psId,
										adbs_paymentstage.pId,
										adbs_paymentstage.ps_76,
										adbs_paymentstage.ps_77,
										adbs_paymentstage.ps_78,
										adbs_paymentstage.ps_79,
										adbs_paymentstage.entDate
										
										
								FROM
										adbs_paymentstage 
								WHERE adbs_paymentstage.pId='$packageID'
							  ";
	...
	$packageView .= "<!-- Tab 3 Start -->
				...
				if($packageCount>0) {
					...
					$packageStatementData	= mysql_fetch_array($packageStatement);							
						$ps_76        = $packageStatementData["ps_76"];
						$ps_77        = $packageStatementData["ps_77"];
						$ps_78        = $packageStatementData["ps_78"];
						$ps_79        = $packageStatementData["ps_79"];
						...
						$packageView .= "
										<tr class='$packageClass'>
											<td colspan='2' style='text-align:left;background:#ffffff;'>
												<p style='font-size:17px;'>Payment Stage Information:</p>	
											</td>
										...
										<tr class='$packageClass'>
											<td style='text-align:left;width:30%;padding-left:10px;'> Total Payments to –date:</td><td style='width: 18%; text-align:left;padding-left:10px;'> $ps_76</td><td style='width:1%; background:#ffffff;'></td>
											<td style='text-align:left;width:30%;padding-left:10px;'> No. of Interim Payments :</td><td style='width: 18%; text-align:left;padding-left:10px;'> $ps_77</td><td style='width:1%; background:#ffffff;'></td>
											
										</tr>
										<tr style='background:#DDDDDD;'>
											<td style='text-align:left;width:30%;padding-left:10px;'>Remaining Contract Amount (equiv. US$) : </td><td style='width: 18%; text-align:left;padding-left:10px;'>".number_format($ps_78,2)."</td><td style='width:1%; background:#ffffff;'></td>
											<td style='text-align:left;width:30%;padding-left:10px;'> </td><td style='width: 18%;text-align:left;padding-left:10px;'> </td>
										</tr>		
					...
					$psBkdnQuery = "
								SELECT
										...
										adbs_paymentstage_bkdn.psbkdn_79a,
										adbs_paymentstage_bkdn.psbkdn_79b,
										adbs_paymentstage_bkdn.psbkdn_79c,
										adbs_paymentstage_bkdn.psbkdn_79d,
										adbs_paymentstage_bkdn.psbkdn_79e,
										adbs_paymentstage_bkdn.psbkdn_79f,
										adbs_paymentstage_bkdn.psbkdn_79g,
								...
								ORDER BY
										adbs_paymentstage_bkdn.psbkdnId
							  ";
					    ...
					    $psbkdn_79a         = $packageStatementData["psbkdn_79a"]; 
						$psbkdn_79a_null = '';
						$psbkdn_79a_date = '';
						if ($psbkdn_79a=='0000-00-00'){
							$psbkdn_79a_null = '';
						}
						else{$psbkdn_79a_date = showDateFormat($packageStatementData["psbkdn_79a"]);
						}
						
						$psbkdn_79b         = $packageStatementData["psbkdn_79b"];
						$psbkdn_79b_null = '';
						$psbkdn_79b_date = '';
						if ($psbkdn_79b=='0000-00-00'){
							$psbkdn_79b_null = '';
						}else{$psbkdn_79b_date = showDateFormat($packageStatementData["psbkdn_79b"]);}
						

					    $psbkdn_79c        = $packageStatementData["psbkdn_79c"];
						$psbkdn_79d        = $packageStatementData["psbkdn_79d"];
						$psbkdn_79e        = $packageStatementData["psbkdn_79e"];
						$psbkdn_79f        = $packageStatementData["psbkdn_79f"];
						$psbkdn_79g        = $packageStatementData["psbkdn_79g"];
						
						
									$paymentBkdnShow .= "<tr class='$packageClass' >
																<td> {$psbkdn_79a_date}</td>
																<td>{$psbkdn_79b_date}</td>
																<td>".number_format($psbkdn_79c,2)."</td>
																<td>{$psbkdn_79d}</td>
																<td>".number_format($psbkdn_79e,2)."</td>
																<td>".number_format($psbkdn_79f,2)."</td>
																<td>{$psbkdn_79g}</td>
															</tr>					
															";						
						$mv++;
						...
						$packageView .= "
										<tr>
											<td colspan='5'>
												<table width='100%' >
												 	<tr style='background:#DDDDDD;'>
														<td> Bill Claim Date</td>
														<td>Payment Date (Cheque Date)</td>
														<td>Amount Paid  (Equiv. US$) </td>
														<td>Payment No.</td>
														<td>Amount for Late Payment</td>
														<td>Amount for liquidated damages</td>
										...
										<tr style='background:#ffffff;'>
											<td style='text-align:left;width:100%;padding-left:10px;font-size:12px;' colspan='5'><center>Last Updated: <b>$entDateps</b>, Updated By: <b>$userName</b></center></td>
										</tr>					
										";
					...
					$packageView .= "
									...
									<tr style='background:#F7F4F4'>
										<td colspan='1' style='text-align:center; color:red;'> 
										<form action='paymentStage.php' method='post'>
										<input type='hidden' name='packageId' value='$packageID'/>
										<input type='hidden' name='packageName' value='$packageName'/>
