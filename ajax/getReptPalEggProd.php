					...
					<tr>
					  ...
					  <tr>
						<td colspan='18' align='center' valign='middle' style='border: 1px dotted #000'>
							...
							<center>&nbsp;</center>
							<center><b><font size=4>Egg Production Report</FONT></b></center>
							<center>&nbsp;</center>
...
// Query here.
						...
						$Global_Quantity = 0;
						$Global_Price	= 0;
						$BasicQuery 	= "SELECT ep.BATCHNO,
												  ep.MURGIQNTY,
												  ep.EGGQNTY,
												  ep.EGGPERCENTAGE,
												  ep.EPDATE
												FROM pal_egg_production ep
												WHERE ep.EPDATE BETWEEN '".$OPENINGDATE_FROM."' AND '".$OPENINGDATE_TO."'
												{$con}
												AND ep.STATUS != 'Out'
												ORDER BY ep.EPDATE
										"; 
						...
						while($BasicQueryStatementData	= mysql_fetch_array($BasicQueryStatement)){	
							...
							$EPDATE			 			= $BasicQueryStatementData['EPDATE'];
							$EGGPERCENTAGE	 			= $BasicQueryStatementData['EGGPERCENTAGE'];
						...
						$tableView .=" <tr>
											...
											<td align='center' valign='top' style='border: 1px dotted #000'>$EPDATE</td>
											...
											<td align='center' valign='top'  style='border: 1px dotted #000'>".number_format($EGGPERCENTAGE,2)." %</td>
					...
					$tableView .="
						...
						<tr style='font-weight:bold;'>
							...
							<td align='center' valign='top' style='border: 1px dotted #000'>$Global_Murgi_Quantity</td>
