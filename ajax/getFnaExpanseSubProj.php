	...
	$tableView .="<table width='50%' border='0' cellpadding='3' cellspacing='0' style='margin:0px auto 0px auto;font-size:85%; border: 1px dotted #000'>
					  ...
					  <tr>
						<td colspan='18' align='center' valign='middle' style='border: 1px dotted #000'>
							...
							<center>&nbsp;</center>
							<center><b><font size=4>All Income/Expanse Head Wise Report</FONT></b></center>
							<center>&nbsp;</center>
						...
						<td colspan='18' align='left' valign='top'>
							<table width='100%' border='0' cellpadding='3' cellspacing='0' style='margin:0px auto 0px auto;font-size:100%;'>
								  ...
								  <tr>
									...
									<td width='1%' align='center' valign='top'>:</td>
									<td width='34%' align='left' valign='top'> All Income / Expanse Head</td>
									<td width='18%' align='right' valign='top'>&nbsp;</td>
...
// Query here.
									 ...
									 $basicIncQuery 		= "SELECT inh.INHID,
										...
										while($basicIncQueryStatementData	= mysql_fetch_array($basicIncQueryStatement)){
												 ...
												 $INCOME_AMOUNT    			= $basicIncQueryStatementData["INCOMEAMOUNT"];
												 $INCHEADNAME       		= $basicIncQueryStatementData["INCHEADNAME"];
												 
												 $TOTAL_AMOUNT_INC			= $TOTAL_AMOUNT_INC + $INCOME_AMOUNT ;
						 ...
						 $tableView .=" <tr>
											...
											<td width='25%' align='left' valign='top' style='border: 1px dotted #000'> &nbsp;</td>
											
											<td width='15%' align='right' valign='top' style='border: 1px dotted #000'>&nbsp;</td>
...
// Query here.
				...
				$sl++;
					...
					$Global_Balance		= $TOTAL_AMOUNT_INC - $TOTAL_AMOUNT ; 
					$tableView .="
						...
						<tr>
							...
							<td align='RIGHT' valign='top' style='border: 1px dotted #000'><b>".number_format($TOTAL_AMOUNT_INC,2)."</b></td>
							...
							<td colspan='5' align='center' valign='top' >
								<table width='50%' border='0' cellpadding='3' cellspacing='0' style='margin:0px auto 0px auto;font-size:100%;'>
								  <tr>
									...
									<td width='48%' style='border: 1px dotted #000'>".number_format($TOTAL_AMOUNT_INC,2)."</td>
								  </tr>
								  <tr>
									<td align='right' width='50%' style='border: 1px dotted #000'>Total Expanse Amount</td>
									<td width='2%' style='border: 1px dotted #000'>:</td>
									<td width='48%' style='border: 1px dotted #000'>".number_format($TOTAL_AMOUNT,2)."</td>
								  </tr>
								  <tr>
