...
function insertDateMySQlFormat($date){
	...
	$tableView .="<table width='60%' border='0' cellpadding='3' cellspacing='0' style='margin:0px auto 0px auto;font-size:85%; border: 1px dotted #000'>
					  ...
					  <tr style='font-weight:bold;'>
						...
						<td align='right' valign='top' style='border: 1px dotted #000'>Pur Balance </td>
						
						<td align='right' valign='top' style='border: 1px dotted #000'>Sell Balance </td>
...
// Query here.
						...
						$Pur_Bill_Balance	= $PURBILLAMOUNT - $PAYMENTAMOUNT ; 
						$Sell_Bill_Balance	= $SELLBILLAMOUNT - $RECEIVEAMOUNT ; 
						$GLOBAL_PARTY_PUR_BALANCE_AMOUNT	= $GLOBAL_PARTY_PUR_BALANCE_AMOUNT + $Pur_Bill_Balance ;
						$GLOBAL_PARTY_SELL_BALANCE_AMOUNT	= $GLOBAL_PARTY_SELL_BALANCE_AMOUNT + $Sell_Bill_Balance ;
						...
						$tableView .=" <tr>
											...
											<td align='right' valign='top' style='border: 1px dotted #000'>".number_format($Pur_Bill_Balance,2)."</td>
					
											<td align='right' valign='top' style='border: 1px dotted #000'>".number_format($Sell_Bill_Balance,2)."</td>
					...
					$tableView .="
						...
						<tr style='font-weight:bold;'>
							...
							<td align='left' valign='top' style='border: 1px dotted #000'>".number_format($GLOBAL_PARTY_PUR_BALANCE_AMOUNT,2)."</td>
							
							<td align='right' valign='top' style='border: 1px dotted #000'>".number_format($GLOBAL_PARTY_SELL_BALANCE_AMOUNT,2)."</td>
