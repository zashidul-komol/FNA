<?php
	...
	if(isset($opId) && (strlen($opId) > 0)) {
		...
		if(isset($_POST['editSubmitPaymentStage'])) {
			 ...
			 $pi_5 			= $_POST['pi_5'];
			 $pi_6 			= $_POST['pi_6']; 
			 $msg 			= $action->paymentStageEditNext($userId,$packageId,$packageName,$pi_4,$pi_5,$pi_6);
		}
		
		if(isset($_POST['insertPaymentStage'])) {
			 $paymentStageInsert 	= new pacakgeInformationInsert();
			 $msg 			= $paymentStageInsert->insertPaymentStageEdit($userId);
