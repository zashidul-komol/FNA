<?php
	class BaseClass {
		...
		var $adminEmail = '"Dhaka Ice Cream Industries Limited" <info@polarbd.com>';
		var $adminEm = 'info@polarbd.com';
		var $pageTitle="Dhaka Ice Cream Industries Limited. ~ Dashboard";
		var $clientWeb="www.polarbd.com";
		...
		function BaseClass() {
			...
			$this->DB_LINK = mysql_connect($this->DB_HOST, $this->DB_USER, $this->DB_PASSW) or die("ERROR: MYSQL CONNECTION ERROR...PROJECT Komol");
