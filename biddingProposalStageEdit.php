<?php
	...
	if(isset($opId) && (strlen($opId) > 0)) {
		...
		if(isset($_POST['editSubmitBiddingProposalStage'])) {
			 ...
			 $pi_5 = $_POST['pi_5'];
			 $pi_6 = $_POST['pi_6']; 
			 $msg 			= $action->biddingProposalStageEditNext($userId,$packageId,$packageName,$pi_4,$pi_5,$pi_6);
		}
		// View Pacakge Information End
		
		if(isset($_POST['editbiddingProposalStage'])) {
			 $biddingProposalStageEdit 	= new pacakgeInformationEditInsert();
			 $msg 			= $biddingProposalStageEdit->biddingProposalStageEidt($userId);
