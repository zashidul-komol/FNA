<?php
	...
	if(isset($opId) && (strlen($opId) > 0)) {
		...
		if(isset($_POST['editSubmitBiddingEvaluationlStage'])) {
			 ...
			 $pi_5 = $_POST['pi_5'];
			 $pi_6 = $_POST['pi_6']; 
			 $msg 			= $action->biddingEvaluationlStageEditNext($userId,$packageId,$packageName,$pi_4,$pi_5,$pi_6);
		}
		// View Pacakge Information End
		
		if(isset($_POST['editBidProposalEvaluationStage'])) {
			 $bidProposalEvaluationStageEdit 	= new pacakgeInformationEditInsert();
			 $msg 			= $bidProposalEvaluationStageEdit->bidProposalEvaluationStageEidt($userId);
