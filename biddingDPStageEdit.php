<?php
	...
	if(isset($opId) && (strlen($opId) > 0)) {
		...
		if(isset($_POST['editSubmitBiddingDPStage'])) {
			 ...
			 $pi_5 = $_POST['pi_5'];
			 $pi_6 = $_POST['pi_6']; 
			 $msg 			= $action->biddingDPStageEditNext($userId,$packageId,$packageName,$pi_4,$pi_5,$pi_6);
		}
		// View Pacakge Information End
		
		if(isset($_POST['editbiddingDPStage'])) {
			 $biddingDPStageEdit 	= new pacakgeInformationEditInsert();
			 $msg 			= $biddingDPStageEdit->biddingDPStageEidt($userId);
