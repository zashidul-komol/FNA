<?php
	...
	if(isset($opId) && (strlen($opId) > 0)) {
		...
		if(isset($_POST['editSubmitOthersInformation'])) {
			 ...
			 $pi_5=  $_POST['pi_5'];
			 $pi_6 = $_POST['pi_6']; 
			 $msg 			= $action->othersInformationEditNext($userId,$packageId,$packageName,$pi_4,$pi_5,$pi_6);
		}
		// View Pacakge Information End
		
		if(isset($_POST['editOthersInformation'])) {
			 $othersInformationEdit 	= new pacakgeInformationEditInsert();
			 $msg 			= $othersInformationEdit->othersInformationEidt($userId);
