<?php
	...
	if(isset($opId) && (strlen($opId) > 0)) {
		...
		if(isset($_POST['editSubmitContractConcludingStage'])) {
			 ...
			 $msg 			= $action->contractConcludingStageEditNext($userId,$packageId,$packageName,$pi_4,$pi_5,$pi_6);
		}
		// View Pacakge Information End
		
		if(isset($_POST['editContractConcludingStage'])) {
			 $contractConcludingStageEdit 	= new pacakgeInformationEditInsert();
			 $msg 			= $contractConcludingStageEdit->contractConcludingStageEidt($userId);
