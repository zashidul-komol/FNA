<?php
	...
	if(isset($opId) && (strlen($opId) > 0)) {
		...
		if(isset($_POST['editSubmitEvaluationReportApprovalStage'])) {
			 ...
			 $pi_5 = $_POST['pi_5'];
			 $pi_6 = $_POST['pi_6']; 
			 $msg 			= $action->evaluationRAStageEditNext($userId,$packageId,$packageName,$pi_4,$pi_5,$pi_6);
		}
		// View Pacakge Information End
		
		if(isset($_POST['editEvaluationPAS'])) {
			 $evaluationPASEdit 	= new pacakgeInformationEditInsert();
			 $msg 			= $evaluationPASEdit->evaluationPASEidt($userId);
